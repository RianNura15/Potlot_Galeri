...
<head>
  ...
  <title>POTLOT GALERI @yield('title','DASHBOARD')</title>
  ...
  <link rel="stylesheet" href="{{asset('public/template/vendors/mdi/css/materialdesignicons.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/template/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" href="{{asset('public/template/vendors/typicons/typicons.css')}}">
  <link rel="stylesheet" href="{{asset('public/template/vendors/simple-line-icons/css/simple-line-icons.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('public/template/js/select.dataTables.min.css')}}">
...
<body>
  ...
  <script src="{{asset('public/template/vendors/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>
  <script src="{{asset('public/template/vendors/progressbar.js/progressbar.min.js')}}"></script>
