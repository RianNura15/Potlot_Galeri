...
<head>
    ...
    <link href="{{ asset('public/sb_admin/') }}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <link
    ...
    <link href="{{ asset('public/sb_admin/') }}/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledy="exampleModalLabel"
        aria-hidden="true">
    ...
    <script src="{{ asset('public/sb_admin') }}/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('public/sb_admin') }}/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('public/sb_admin') }}/js/demo/chart-area-demo.js"></script>
    <script src="{{ asset('public/sb_admin') }}/js/demo/chart-pie-demo.js"></script>
