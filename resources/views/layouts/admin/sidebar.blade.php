<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('pemilik.user.anggota')}}">Anggota</a>
  ...
  <li class="nav-item">
    ...
    <div id="transaksiCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('admin.pembayaran.index')}}">PENJUALAN</a>
        <a class="collapse-item" href="{{route('admin.pembayaran.custom')}}">CUSTOM</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#colapsePembayaran" aria-expanded="true" aria-controls="colapsePembayaran">
      <i class="fas fa-fw fa-folder"></i>
      <span>TRANSAKSI</span>
    </a>
    <div id="colapsePembayaran" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('marketing.transaksi.custom')}}">CUSTOM</a>
        <a class="collapse-item" href="{{route('marketing.transaksi.pesan')}}">PEMESANAN</a>
      </div>
    </div>
  </li>
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#colapsePembayaranCstm" aria-expanded="true" aria-controls="colapsePembayaranCstm">
      <i class="fas fa-fw fa-folder"></i>
      <span>PENDAPATAN</span>
    </a>
    <div id="colapsePembayaranCstm" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <a class="collapse-item" href="{{route('marketing.pendapatan.index')}}">PEMESANAN</a>
        <a class="collapse-item" href="{{route('marketing.pendapatan.cstm')}}">CUSTOM</a>
      </div>
    </div>
  </li>
  {{-- <li class="nav-item">
